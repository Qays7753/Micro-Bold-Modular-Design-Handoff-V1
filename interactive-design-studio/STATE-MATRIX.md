...
**المرجع:** §13.20 (محورا معنى القيمة والحفظ) + §14 (النظام السياقي) + SCREEN-COVERAGE-V2.csv (الحالات المطلوبة) + 17 §2 (ألوان الحالات). النموذج في `src/states/types.ts`. ألوان الحالات دلالية (نجاح/انتباه/خطر/جزئي/معلومة) — لون الهوية ليس حالة.
