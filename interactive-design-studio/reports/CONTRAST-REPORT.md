...
**المرجع:** `COLOR-STANDARD-V2.md` §§2–3 — أُعيد حساب كل زوج فعلي من النسخة الجديدة بعد استبدال منظومة الألوان. نتائج الإصدار السابق (Indigo/Citrus) لا تنتقل إلى هذه الجولة.
...
**القيم المشتقة وموثقة** (COLOR-STANDARD-V2.md §2 يفوّض الضغط/التعطيل لـZAI): `#8F3B27` (مضغوط Action)، `#C4663F` (عمق هوية غير نصي)، `#E4EAEC` (سطح ثانٍ مرئي)، `#8A959C` (نص معطل).
...
| White على Action (الزر الصلب) | `#FFFFFF` | `#A94630` | btn--primary وdialog__action--primary وbottom-nav__badge | 4.5:1 | 5.82:1 | PASS | COLOR-STANDARD-V2.md §2 Action/On-Action |
...
| Partial على Partial-Surface | `#5B6770` | `#EDF1F2` | كلمات الجزئي/غير المعروف + بطاقات partial/unknown | 4.5:1 | 5.10:1 | PASS | --c-partial (COLOR-STANDARD-V2.md §2 Partial/Unknown) |
...
| Boundary على Canvas (حد الحقل الضروري) | `#78868D` | `#F0F3F4` | حد الحقول والأزرار الثانوية | 3.0:1 | 3.37:1 | PASS | COLOR-STANDARD-V2.md §2 Necessary control outline |
...
- **النص المعطل** `#8A959C` بلا شفافية (16.6 §16.3): WCAG لا يفرض حدًا للمعطل لكنه مقيس وموثق، وأفتح من Unknown `#5B6770` كي لا يبدو بيانات مجهولة (COLOR-STANDARD-V2.md §2).
