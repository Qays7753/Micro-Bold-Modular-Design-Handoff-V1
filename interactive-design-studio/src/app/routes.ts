...
// V2: أُضيفت مسارات مؤجلة حقيقية (SCREEN-COVERAGE-V2.csv) لكل إجراء مرئي كي لا يبقى نقر
...
export const ROUTES: Record<string, ScreenRoute> = {
  'OVR-NOW': {
    ...
    level: 1,
    status: 'built',
    decisionRefs: '§13.2 | §13.4 | §13.19 | §13.20 | §21.3 (SCREEN-COVERAGE-V2.csv: OVR-NOW)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → OVR-NOW · Required: Complete|Partial|Insufficient|FirstUse|Offline|Error',
  ...
  'OPS-SALE-CREATE': {
    ...
    level: 3,
    status: 'built',
    decisionRefs: '§12 | §13.8 | §13.20 | §21.3 (SCREEN-COVERAGE-V2.csv: OPS-SALE-CREATE)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → OPS-SALE-CREATE · Required: Empty|Filled|Validation|Impact|Saving|Failure|Success',
  ...
  'FIN-OVERVIEW': {
    ...
    level: 1,
    status: 'built',
    decisionRefs: '§13.2 | §13.3 | §13.11 | §13.12 | §13.20 | §21.3 (SCREEN-COVERAGE-V2.csv: FIN-OVERVIEW)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → FIN-OVERVIEW · Required: Complete|Partial|Insufficient|Zero|Negative|Offline',
  ...
  'OVR-SNAPSHOT-ALL': {
    ...
    level: 2,
    status: 'built',
    decisionRefs: '§13.4 | §21.3 (SCREEN-COVERAGE-V2.csv: OVR-SNAPSHOT-ALL) + DESIGN-SYSTEM §2',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → OVR-SNAPSHOT-ALL · Required: Loaded|Partial|Unknown',
  ...
  'STUDIO-COMPONENTS': {
    ...
    status: 'built',
    studioOnly: true,
    decisionRefs: 'IMPLEMENTED-COVERAGE-V2 §2.3 (مساحة مراجعة مخصصة) — ليست شاشة منتج',
    coverageRow: 'IMPLEMENTED-COVERAGE-V2 → كل مكوّن وVariant منفذ قابل للفحص',
  ...
  'OPS-HOME': {
    ...
    level: 1,
    status: 'deferred',
    decisionRefs: '§11 | §21.3 (SCREEN-COVERAGE-V2.csv: OPS-HOME)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → OPS-HOME · Required: Loaded|FirstUse|Busy|Offline',
    entryNote: 'مركز العمليات — غير مصممة بعد — يُستخدم المرجع المرئي V2 عند العمل عليها.',
    scenarios: [],
  },
  'TOOL-HOME': {
    screenId: 'TOOL-HOME',
    ...
    level: 1,
    status: 'deferred',
    decisionRefs: '§21.3 (SCREEN-COVERAGE-V2.csv: TOOL-HOME)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → TOOL-HOME · Required: Loaded|Empty|Unavailable',
  ...
  'MKT-HOME': {
    ...
    level: 1,
    status: 'deferred',
    decisionRefs: '§11.6 | §21.3 (SCREEN-COVERAGE-V2.csv: MKT-HOME · ConditionalVerify)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → MKT-HOME · Required: ValueNow|Empty|Loading|Offline',
    entryNote: 'التبويب الخامس معتمد وظاهر؛ محتوى الإطلاق يحتاج تحققًا — GAP-005 (لا عروض مختلقة ولا «قريبًا»).',
    scenarios: [],
  },
  // ===== مسارات مؤجلة (SCREEN-COVERAGE-V2.csv) تفتح من إجراءات مرئية — لا نقر ميت =====
  'FIN-ACTIVITY': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§13.5 | §21.3 (SCREEN-COVERAGE-V2.csv: FIN-ACTIVITY)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → FIN-ACTIVITY · Required: Loaded|FilteredEmpty|Loading|Offline|PendingSync',
  ...
  'FIN-TRANSACTION-DETAIL': {
    ...
    level: 3,
    status: 'deferred',
    decisionRefs: '§13.10 | §15.6 | §21.3 (SCREEN-COVERAGE-V2.csv: FIN-TRANSACTION-DETAIL)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → FIN-TRANSACTION-DETAIL · Required: Loaded|Partial|Error|SensitiveAction',
  ...
  'OPS-EXPENSE-CREATE': {
    ...
    level: 3,
    status: 'deferred',
    decisionRefs: '§12 | §21.3 (SCREEN-COVERAGE-V2.csv: OPS-EXPENSE-CREATE)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → OPS-EXPENSE-CREATE · Required: Empty|Filled|Validation|Saving|Failure|Success',
  ...
  'FIN-WALLETS': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§13.7 | §21.3 (SCREEN-COVERAGE-V2.csv: FIN-WALLETS)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → FIN-WALLETS · Required: Loaded|Empty|Unavailable|Offline',
  ...
  'FIN-TRANSFER': {
    ...
    level: 3,
    status: 'deferred',
    decisionRefs: '§12 | §13.8 | §21.3 (SCREEN-COVERAGE-V2.csv: FIN-TRANSFER)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → FIN-TRANSFER · Required: Empty|Impact|Saving|Failure|Success',
  ...
  'REL-CUSTOMERS': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§10.2 | §21.3 (SCREEN-COVERAGE-V2.csv: REL-CUSTOMERS)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → REL-CUSTOMERS · Required: Loaded|FirstUse|FilteredEmpty|Offline',
  ...
  'REL-SUPPLIERS': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§10.2 | §21.3 (SCREEN-COVERAGE-V2.csv: REL-SUPPLIERS)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → REL-SUPPLIERS · Required: Loaded|FirstUse|FilteredEmpty|Offline',
  ...
  'GLB-ASK': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§11.7 | §21.3 (SCREEN-COVERAGE-V2.csv: GLB-ASK)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → GLB-ASK · Required: Loaded|Unavailable|Error',
  ...
  'GLB-DELIVERY': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§11.7 | §21.3 (SCREEN-COVERAGE-V2.csv: GLB-DELIVERY)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → GLB-DELIVERY · Required: Loaded|Unavailable|Error',
  ...
  'GLB-ACCOUNT': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§11.9 | §21.3 (SCREEN-COVERAGE-V2.csv: GLB-ACCOUNT)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → GLB-ACCOUNT · Required: Loaded|Incomplete|Error',
  ...
  'GLB-PROJECT': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§11.9 | §21.3 (SCREEN-COVERAGE-V2.csv: GLB-PROJECT)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → GLB-PROJECT · Required: Complete|Incomplete|Error',
  ...
  'GLB-SETTINGS': {
    ...
    level: 2,
    status: 'deferred',
    decisionRefs: '§11.9 | §21.3 (SCREEN-COVERAGE-V2.csv: GLB-SETTINGS)',
    coverageRow: 'SCREEN-COVERAGE-V2.csv → GLB-SETTINGS · Required: Loaded|Unavailable',
