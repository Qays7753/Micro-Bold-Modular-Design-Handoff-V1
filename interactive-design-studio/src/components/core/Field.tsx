...
// Focus: حد Information (#305968) بحلقة سطح هادئ بلا تغيير حجم. الخطأ:
// حد Danger + أيقونة + رسالة محددة أسفل الحقل بلا خلفية حمراء. المبلغ:
// أرقام LTR و«د.أ» في الطرف المقابل، ولا تنسيق آلاف أثناء الكتابة.
