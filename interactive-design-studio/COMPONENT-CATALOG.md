...
> كل مكوّن منفذ أدناه **قابل للفحص حيًّا**: في سيناريو موجود أو داخل `#/STUDIO-COMPONENTS` (مساحة مراجعة الاستوديو). التفصيل الكامل لنتائج الفحص في `reports/IMPLEMENTED-COVERAGE-V2.md`.
...
- `StudioShell/ReviewControls`: شريط **مدمج قابل للطي** — الشاشة والحالة ظاهران دائمًا، وأدوات العرض (العرض/التكبير/الرمادي/الحركة) خلف زر ملخص `360 · 100%` (DESIGN-SYSTEM.md §1) بلون كروم Information منفصل عن هوية الهاتف. درج معلومات الشاشة + عن الاستوديو + روابط عميقة.
