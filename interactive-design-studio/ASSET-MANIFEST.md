...
> **لون الإصدار السابق:** معلومات الألوان/التوكنز أدناه تصف نسخة ما قبل القرار الجديد؛ الأصول وتراخيصها التاريخية تبقى كما رصدت. يعيد ZAI توليد مرجع الألوان بعد تعديل الكود وفق ملف 17.
