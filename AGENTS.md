...
القرارات المعتمدة في `MICRO-VISUAL-DESIGN-DECISIONS-V1.md` والملفات المرقمة أعلى سلطة من أي اقتراح جديد. عند وجود فجوة، سجلها بدل التخمين. لا تغيّر الألوان أو التبويبات أو RTL أو `د.أ` أو حدود الوظائف إلا عبر Proposal واضح وموافقة المالك.
